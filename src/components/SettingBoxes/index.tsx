                  ...
                  <div className="w-full sm:w-1/2">
                    ...
                    <div className="relative">
                      <input
                        ...
                        name="country"
                        id="country"
                        placeholder={farmer.farmCountry}
                        defaultValue={farmer.farmCountry}
                      />
                    </div>
                  </div>
                  <div className="w-full sm:w-1/2">
                    ...
                    <div className="relative">
                      <input
                        ...
                        name="city"
                        id="city"
                        placeholder={farmer.farmCity}
                        defaultValue={farmer.farmCity}
                      />
                    </div>
                  </div>
                </div>
                  ...
                  <div className="w-full sm:w-1/2">
                    ...
                    <div className="relative">
                      <input
                        ...
                        name="address"
                        id="address"
                        placeholder={farmer.farmAddress}
                        defaultValue={farmer.farmAddress}
                      />
                    </div>
                  </div>
                  <div className="w-full sm:w-1/2">
                    ...
                    <div className="relative">
                      <input
                        ...
                        name="postalCode"
                        id="postalCode"
                        placeholder={farmer.farmPostalCode}
                        defaultValue={farmer.farmPostalCode}
                      />
                    </div>
                  </div>
                </div>
                ...
                <div className="mb-4 flex items-center gap-3">
                  <div className="h-14 w-14 rounded-full">
                    <>
                      <Image
                        src={
                          farmer.personalPhoto || "/images/default-avatar.png"
                        }
                        width={55}
                        height={55}
                        alt="User"
